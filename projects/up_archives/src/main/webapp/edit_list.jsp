...
<div class="container-fluid">
      ...
      <ol class="breadcrumb button3">
        ...
        <li class="breadcrumb-item active"><b><span style="color:white;">Update List Of List</span></b></li>
      </ol>
...
<input class="form-control" type="text" name="sublist" autocomplete="off" value="<%=request.getParameter("sub_list") %>" maxlength="5" placeholder="Enter Sub List" required="" id="sublist" />
...
<input class="form-control " type="text" name="doc_year_from" autocomplete="off" value="<%=request.getParameter("doc_year_from")%>" placeholder="Enter Document Year From" required="" id="doc_year_from" onkeypress="return isNumberKey(event)" maxlength="4"/>
</div>
...
<input class="form-control" type="text" name="doc_year_to" autocomplete="off" value="<%=request.getParameter("doc_year_to")%>" placeholder="Enter Document Year To" required="" id="doc_year_to" onkeypress="return isNumberKey(event)" maxlength="4"/>
...
<input class="form-control datepick" type="text" autocomplete="off" value="<%=request.getParameter("doc_receive_date")%>" name="doc_receive_date" placeholder="Enter Document Receive Date" required="" id="doc_receive_date" />
</div>
...
<input class="butclass button" type="button"  value="Update" id="update_lol"/>&nbsp;&nbsp;
 ...
 <script type="text/javascript">
    ...
    $(function () {
        ...
        $('#update_lol').click(function () {  	 
        	...
        	if (document.getElementById('doc_receive_date').value=="") {
